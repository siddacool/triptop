<script lang="ts">
  ...
  let timeInputElement: HTMLInputElement | undefined = $state(undefined);
  ...
  function onclick(e: MouseEvent) {
    ...
    if (timeInputElement.showPicker) {
      timeInputElement.showPicker();
    } else {
...
<div class="TimeInput">
  ...
  >
    {#if value}
      {getMoment(value, 'HH:mm').format('h:m A')}
    {:else}
